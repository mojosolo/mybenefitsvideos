// pricing_calculator_example.ts
// Example usage of the pricing schema selections to compute totals.
// Drop this into your Magic UI + MCP project and wire it to your form state.
...
export function computePricing(sel: PricingSelections): PricingBreakdown {
  ...
  // Foundation (required in most quotes)
  if (sel.foundation) {
  ...
  if (sel.microsite === 'standalone') {
    ...
    // Optional: show savings math versus standalone
